...
export default function Modal({ children, isOpen, onClose, title }) {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black-20 bg-opacity-50">
      <div className="relative p-4 w-full mx-w-2xl max-h-full">
        {/* Modal content */}
        <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 outline-2 outline-offset-2 outline-gray-200">
          {/* Modal Header */}
